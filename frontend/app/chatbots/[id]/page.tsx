        ...
        <DashboardLayout>
            ...
            {showExport && chatbot && (
                <ExportPanel
                    ...
                    isPublic={chatbot.is_public}
                    publicToken={chatbot.public_token || ""}
                    accentPrimary={chatbot.accent_primary || "#715A5A"}
                    accentSecondary={chatbot.accent_secondary || "#2D2B33"}
                    onClose={() => setShowExport(false)}
                    onPublishChange={(val) => setChatbot({ ...chatbot, is_public: val })}
                />
            )}
        </DashboardLayout>
    );
