...
def index_chatbot_documents(chatbot_id: UUID, documents: list) -> int:
    ...
    # Download and parse all documents into LlamaIndex Documents
    li_documents = []
    ...
    # Build index (chunks, embeds, and stores in one go)
